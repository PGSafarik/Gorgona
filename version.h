...
namespace AutoVersion{
	...
	static const char UBUNTU_VERSION_STYLE[] =  "03.08";
	...
	#define RC_FILEVERSION 1,6,4,3
	#define RC_FILEVERSION_STRING "1, 6, 4, 3\0"
	static const char FULLVERSION_STRING [] = "1.6.4.3";
