...
--- Pomocne rutiny ---
function __unpack( list, num )
  num = num or 1
  n = #list
  
  if num < n      then return __unpack( list, num + 1 )
  elseif num == n then return list[ n ]
  elseif num > n  then return nil
  end
end
...
function split( s, sep )
  ...
  for str in string.gmatch( s, lt_str ) do
    n = n + 1
    table.insert( t, n, str ) 
  end
...
function Mod_Load( dir )
	
	dir = dir or "." 
	
	local list = io.popen( "ls -1 " .. dir )
